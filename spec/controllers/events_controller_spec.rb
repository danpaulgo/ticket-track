...
RSpec.describe EventsController, type: :controller do
  ...
  describe "GET #show" do
    context "logged in user" do
      context "with own user_id" do
        it "renders show page" do
          get :show, params: {id: event.id, user_id: user.id}, session: logged_in_session
      ...
      context "without user_id" do
        it "redirects to user's show page" do
          get :show, params: {id: event.id}, session: admin_session
    ...
    context "logged out user" do
      it "redirects to home page" do
        get :show, params: {id: event.id, user_id: user.id}, session: logged_out_session
        expect(response).to redirect_to(root_path)
      end
    end
  end
